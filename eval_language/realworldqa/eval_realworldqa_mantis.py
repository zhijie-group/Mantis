...
model_path = "/data/yangyi/metaquery_action_refactoring/output_queue_h200/metaquery_image_action_language_queue_h200/checkpoint-22586"
...
output_file = os.path.join(log_dir, f"mantis_results_{timestamp}.json")
